...
- **Artifacts written:** {len(artifact_paths)} compact report, specification, fixture, validation, accounting, provenance, and manifest files under `/artifacts/research_steps/S03/`, including the canonical `lesion_library/`.
