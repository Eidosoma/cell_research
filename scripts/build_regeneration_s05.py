...
- **Artifacts written:** Frozen nudge/recovery specification and schema, 3,840-row result/scenario tables, 2,304 calibration-to-control assignments, 2,304 paired contrasts, four primary and 12 formal matching-sensitivity tests, matching plot, eight full traces, validation/accounting/provenance manifests, and this canonical report under `{output}`.
