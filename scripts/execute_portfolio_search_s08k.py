#!/usr/bin/env python3
"""Execute S08K in its prospectively frozen, genuinely fresh namespace."""
...
os.environ["E07_PORTFOLIO_STEP_ID"] = "S08K"
os.environ["E07_PORTFOLIO_CONTROL_PATH"] = str(
    REPOSITORY / "configs/portfolio/s08k_execution_continuation.yaml"
)
os.environ["E07_PORTFOLIO_CACHE_ROOT"] = "/cache/e07-s08k"
