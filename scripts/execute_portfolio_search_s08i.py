#!/usr/bin/env python3
"""Execute S08I in its prospectively frozen, genuinely fresh namespace."""
...
os.environ["E07_PORTFOLIO_STEP_ID"] = "S08I"
os.environ["E07_PORTFOLIO_CONTROL_PATH"] = str(
    REPOSITORY / "configs/portfolio/s08i_execution_continuation.yaml"
)
os.environ["E07_PORTFOLIO_CACHE_ROOT"] = "/cache/e07-s08i"
